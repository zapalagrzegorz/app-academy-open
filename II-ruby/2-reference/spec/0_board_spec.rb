...
describe "Board" do
  let(:board) { Board.new(["card1", "card2"]) }

  describe "#initialize" do
    it "should accept array of Cards as an arg" do
      board
    end

    it "should set @board to be a 2D array with n rows and n columns" do
      grid = board.instance_variable_get(:@grid)
      expect(grid.length).to eq(4)
      expect(grid[0].length).to eq(4)
    end
    ...
    describe "#populate" do
      it "should populate grid with random values of alphabet" do
