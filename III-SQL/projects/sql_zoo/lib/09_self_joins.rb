...
def start_at_craiglockhart
  ...
  execute(<<~SQL)
    ...
    end_route_stops.name,
        ...
        JOIN routes AS end_routes ON (
            start_routes.company = end_routes.company
            AND start_routes.num = end_routes.num
          )
        JOIN stops AS end_route_stops ON end_route_stops.id = end_routes.stop_id
        WHERE
...
def craiglockhart_to_sighthill
  ...
  FROM
  routes AS start
  JOIN routes AS to_transfer ON start.num = to_transfer.num
  AND start.company = to_transfer.company
  ...
  JOIN routes AS finish ON finish.num = from_transfer.num AND finish.company = from_transfer.company
